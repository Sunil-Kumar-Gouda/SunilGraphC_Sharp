...
namespace Graph.MST
{
    class Prims
    {
        ...
        private void FindMst()
        {
            ...
            List<DirectedEdge> temp = new List<DirectedEdge>(G.Edges);
            ...
            SortedSet<DirectedEdge> sortedEdges = new SortedSet<DirectedEdge>();
